...
public class ExamCapsule {
	private int kor;
	private int eng;
	private int math;
	//변수 선언이 아님. 선언은 함수안에서. 클래스 안 x
	
	public static void setKor(ExamCapsule exam, int kor) {
		exam.kor=kor;
	}
	...
	public static void input(ExamCapsule exam) {
	...
	public static void print(ExamCapsule exam) {
		int kor=exam.kor;
		int eng=exam.eng;
		int math=exam.math;
